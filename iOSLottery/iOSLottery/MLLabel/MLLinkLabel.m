...
+ (instancetype)linkWithType:(MLLinkType)type value:(NSString*)value range:(NSRange)range color:(UIColor *)color
{
    return [MLLink linkWithType:type value:value range:range linkTextAttributes:@{NSForegroundColorAttributeName:color} activeLinkTextAttributes:@{NSForegroundColorAttributeName:color}];
}
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch {
    if ([NSStringFromClass([touch.view class]) isEqualToString:@"MLLinkLabel"])
    {
