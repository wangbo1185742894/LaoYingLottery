...
@interface BBMatchBetBottomView ()
...
@implementation BBMatchBetBottomView
...
- (void)reloadUI{
    ...
    BOOL hasDanGuan = [[BBMatchInfoManager shareManager] getSelectMatchHasDanGuan];
    NSInteger matchCount = [[BBMatchInfoManager shareManager] getSelectMatchCount];
