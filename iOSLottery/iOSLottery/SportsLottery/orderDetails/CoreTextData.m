...
- (void)fillImagePosition
{
    ...
    for (int i = 0; i< lineCount; i++) {
        ...
        for (id runObj in runObjArr) {
            ...
            if (![metaDic isKindOfClass:CTUnit.class]) {
                continue;
            }
            ...
            CGRect delegateBonus = CGRectOffset(runBounds, colRect.origin.x, colRect.origin.y);
            
            imageData.imagePosition = delegateBonus;
            imgIndex++;
