...
@interface BBDrawNoticeHeaderView ()
...
@implementation BBDrawNoticeHeaderView
...
+ (instancetype)createBBDrawNoticeHeaderViewWithTableView:(UITableView *)tableView
{
    ...
    BBDrawNoticeHeaderView *headView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:idHeadView];
    
    if (headView == nil) {
        
        headView = [[BBDrawNoticeHeaderView alloc] initWithReuseIdentifier:idHeadView];
    }
    return headView;
...
- (void)setHeaderModel:(BBDrawNoticeGroupModel *)headerModel
{
