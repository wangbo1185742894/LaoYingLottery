...
@implementation BBBetDetailsCell
...
+ (instancetype)createBetDetailsCellWithTableView:(UITableView *)tableView
{
    ...
    BBBetDetailsCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    
    if (!cell) {
        
        cell = [[BBBetDetailsCell alloc] initWithStyle:(UITableViewCellStyleDefault) reuseIdentifier:ID];
    }
    return cell;
}
