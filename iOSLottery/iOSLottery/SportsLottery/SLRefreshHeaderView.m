...
@interface SLRefreshHeaderView ()
{
    __unsafe_unretained UIImageView *_arrowView;
}

@property (nonatomic, strong) SLRefreshHeaderCustomView *refreshView;
@end
@implementation SLRefreshHeaderView

#pragma mark - 懒加载子控件

- (SLRefreshHeaderCustomView *)refreshView
{
    if (!_refreshView) {
        SLRefreshHeaderCustomView *refreshView = [[SLRefreshHeaderCustomView alloc] init];
...
- (void)prepare
{
    ...
    self.stateLabel.font = SL_FONT_SCALE(12.f);
    self.stateLabel.textColor = SL_UIColorFromRGB(0x666666);
