...
+ (void)reachabilityNetworkStateDidChangeState:(AFNetworkReachabilityStatus)state {
    ...
    if (state == AFNetworkReachabilityStatusUnknown ||
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:NetworkReachabilityDidChangeNotificationName object:nil userInfo:@{APP_HASNET : @(0)}];
    }else{
        [[NSNotificationCenter defaultCenter] postNotificationName:NetworkReachabilityDidChangeNotificationName object:nil userInfo:@{APP_HASNET : @(1)}];
    }
}
