...
@interface CLBetDetailTableFooterView ()
...
@end
@implementation CLBetDetailTableFooterView
...
- (void)configConstraint{
    ...
    [self.agreeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.agreeImageView.mas_right).offset(__SCALE(7.f));
...
- (UIImageView *)agreeImageView{
    ...
    if (!_agreeImageView) {
        ...
        _agreeImageView.contentMode = UIViewContentModeScaleAspectFill;
        _agreeImageView.image = [UIImage imageNamed:@"ft_checkRight.png"];
    }
...
- (UILabel *)agreeLabel{
    ...
    if (!_agreeLabel) {
        ...
        _agreeLabel.textColor = UIColorFromRGB(0x71bb99);
        _agreeLabel.font = FONT_SCALE(13);
    }
    return _agreeLabel;
}
- (UIButton *)agreementButton{
    ...
    if (!_agreementButton) {
        ...
        [_agreementButton setTitle:@"《服务协议》" forState:UIControlStateNormal];
        [_agreementButton setTitleColor:UIColorFromRGB(0x71bb99) forState:UIControlStateNormal];
        _agreementButton.titleLabel.font = FONT_SCALE(13);
