...
- (void)layoutSubviews {
    ...
    self.reportButton.frame = CGRectMake(160, 0, 80, self.bounds.size.height);
}
    ...
    [UIView animateWithDuration:0.2f
         ...
         usingSpringWithDamping:0.7
          initialSpringVelocity:0.0f
                        options:0
                     animations:^{
                         self.frame = CGRectMake(self.frame.origin.x - 240,
                                                 self.frame.origin.y,
                                                 240,
                                                 34.0f);
...
- (UIButton *)reportButton {
    ...
    [_reportButton setImage:[UIImage imageNamed:@"c.png"] forState:UIControlStateNormal];
