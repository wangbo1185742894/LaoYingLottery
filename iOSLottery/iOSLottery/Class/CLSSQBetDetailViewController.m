//
//  CLSSQBetDetailViewController.m
//  iOSLottery
//
...
#import "CLSSQBetDetailViewController.h"
...
@interface CLSSQBetDetailViewController ()<UITableViewDelegate, UITableViewDataSource, CLRequestCallBackDelegate, CLCreateOrderDelegate, CLAlertControllerDelegate>
...
@implementation CLSSQBetDetailViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    WS(_weakSelf)
    static NSString *cellId = @"CLSSQDetailCell";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [CLSSQViewController presentSSQViewControllerWithInitialVC:self selectedIndex:self.dataSourceArray.count - indexPath.row - 1 isSelectBetInfo:YES gameEn:self.lotteryGameEn completion:^{
...
- (void)getData{
    ...
    CLSSQDetailDataManager *dataManager = [[CLSSQDetailDataManager alloc] init];
