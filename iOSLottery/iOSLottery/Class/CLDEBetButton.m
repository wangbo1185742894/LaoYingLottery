...
- (void)touchDown:(CLDEBetButton *)betBtn{
    
    self.scaleAnimation = YES;
}
- (void)touchUpInside:(CLDEBetButton *)betBtn{
    
    self.selected = !self.selected;
    self.scaleAnimation = NO;
}
- (void)touchUpOutside:(CLDEBetButton *)btn{
    //不做选中改变 只是收起动画
    self.scaleAnimation = NO;
}
- (void)touchUpCancel:(CLDEBetButton *)btn{
    //不做选中改变 只是收起动画
    self.scaleAnimation = NO;
}
...
- (void)selectSelfState{
    ...
    self.contentLabel.backgroundColor = UIColorFromRGB(0xd90000);
    self.contentLabel.layer.borderWidth = 0;
}
#pragma mark - 未选中时的状态
- (void)noSelectSelfState{
    
    self.contentLabel.textColor = UIColorFromRGB(0xd90000);
...
- (UILabel *)contentLabel{
    ...
    if (!_contentLabel) {
        ...
        _contentLabel.textColor = UIColorFromRGB(0xd90000);
