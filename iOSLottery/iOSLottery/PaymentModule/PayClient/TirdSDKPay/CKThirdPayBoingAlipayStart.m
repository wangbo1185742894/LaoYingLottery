...
@implementation CKThirdPayBoingAlipayStart
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.isNeedHandleException = NO;
        self.channelID = CKThirdPayMentChannelIDBoingAlipay;
        self.nextPayResponder = [[CKThirdPayBoingWXStart alloc] init];
    }
    return self;
}
